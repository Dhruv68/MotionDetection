# -*- coding: utf-8 -*-
"""
Created on Fri Jul 26 14:41:03 2019
...
# init camera
camera = cv2.VideoCapture(0) # Add the video path or the webcamp or the external camera.
camera.set(3,320)
camera.set(4,240)
time.sleep(0.5)
...
while 1:
    ...
    for c in contours:
        ...
        cv2.circle(frame6,(cx,cy),2,(0,255,255),2)
        cv2.circle(frame6,(rx,ry),2,(255,255,0),2)
    ...
    frame7 = frame0.copy()
    if targets:
        cv2.circle(frame7,(mx,my),tr,(0,255,255,0),2)
        cv2.line(frame7,(mx-tr,my),(mx+tr,my),(0,255,255,0),2)
        cv2.line(frame7,(mx,my-tr),(mx,my+tr),(0,255,255,0),2)
